...
$query="SELECT a.*,b.bf_source,b.bf_file FROM  g4_write_news a,g4_board_file b where a.wr_id = b.wr_id and b.bo_table ='news' order by a.wr_datetime desc limit 0,6";
...
?>
	               <div class="item news-post">
						<img src="/data/file/news/<?php echo $bf_file; ?>" alt="" width="449" height="250">
