<?php 
	...
	#Your e-mail address
	//define("__TO__", "info@bioinksolutions.com");
    define("__TO__", "tgchoi72@gmail.com");
	#Message subject
	define("__SUBJECT__", "bioinksolutions.com = From:");

	#Success message
	define('__SUCCESS_MESSAGE__', "Your order has been sent. Thank you!");
	...
	if(isset($_POST['name']) and isset($_POST['mail']) and isset($_POST['comment'])){
		...
		if($name == '') {
			echo json_encode(array('info' => 'error', 'msg' => "Please enter your name.1111"));
			exit();
		} else if($mail == '' or check_email($mail) == false){
			echo json_encode(array('info' => 'error', 'msg' => "Please enter valid e-mail1111."));
			exit();
		} else if($comment == ''){
			echo json_encode(array('info' => 'error', 'msg' => "Please enter your message2222."));
			exit();
		} else {
			//Send Mail
			$to = __TO__;
